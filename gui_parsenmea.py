...
class Interface(tk.Tk):
    ...
    def open_file(self):
        self.filename = askopenfilename(initialdir="C:/SwisstopoMobility/analysis/DataBase",
    ...
    def open_folder(self):
        self.filename = askdirectory(initialdir="C:/SwisstopoMobility/analysis/DataBase",
